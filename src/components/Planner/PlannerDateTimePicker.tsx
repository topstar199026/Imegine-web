...
const PlannerDateTimePicker: FC<Props> = (props) => {
		...
		<div
			...
			<ClickButton
				...
				<div
					...
					<img 
						style={$style([$size(14.5, 16)])} 
						src={images.planner.plannerCalendarBlue4x} alt='' 
					/>
				</div>
				<div
					style={$style([
...
export default PlannerDateTimePicker;
